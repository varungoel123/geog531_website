...
4.  Navigate to Map \| Rates-Calculated Map \| Empirical Bayes (or right click in the map area and choose Rates \| Empirical Bayes). Choose cases for the Event Variable and pop for the Base Variable, and then change the Map Themes to Natural Breaks and the number of Categories to 5. Click OK.
...
[**Q.2 What is the Moran's I value and pseudo p-value? What is your interpretation of this output?** ]{style="color: red;"}
